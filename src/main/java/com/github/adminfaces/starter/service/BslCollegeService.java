...
import com.github.adminfaces.starter.model.BilanParSpecialiteLettreCollege_;
 ...
 */
@Stateless
public class BslCollegeService extends CrudService<BilanParSpecialiteLettreCollege, Integer> implements Serializable {
...
//        }
    ...
    public BilanParSpecialiteLettreCollege exists(Eleve eleve, Integer trimestre, AnneeAcademique annee) {
        BilanParSpecialiteLettreCollege bsl = criteria()
                .eq(BilanParSpecialiteLettreCollege_.eleve, eleve)
                .eq(BilanParSpecialiteLettreCollege_.trimestre, trimestre)
                .eq(BilanParSpecialiteLettreCollege_.anneeAcademique, annee)
                .getOptionalResult();
        return bsl ;
    }
}
