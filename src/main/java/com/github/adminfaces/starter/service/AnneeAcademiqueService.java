...
import com.github.adminfaces.starter.repository.AnneeAcademiqueRepository;
...
public class AnneeAcademiqueService {
    ...
    public Optional<AnneeAcademique> getCurrentAnneeAcademaique(){
        return anneeAcademiqueRepository.findAnneeAcademiqueByStatutIsTrue();
    }
