...
@NamedQueries({
    ...
    @NamedQuery(name = "Bulletin.findByAnnee", query = "SELECT b FROM Bulletin b WHERE b.annee = :annee"),
...
public class Bulletin extends BaseEntity implements Serializable,Comparable<Bulletin> {
    ...
    public String toString() {
        return "com.github.adminfaces.starter.model.model.Bulletin[ id=" + id + " ]";
    }
