 ...
 */
@Entity
@Table(name = "bilan_specialite_lettre_lycee")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "BilanParSpecialiteLettreLycee.findAll", query = "SELECT b FROM BilanParSpecialiteLettreLycee b")})
public class BilanParSpecialiteLettreLycee extends BaseEntity implements Serializable,Comparable<BilanParSpecialiteLettreLycee> {
    ...
    public BilanParSpecialiteLettreLycee() {
    }

    public BilanParSpecialiteLettreLycee(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BilanParSpecialiteLettreLycee)) {
            return false;
        }
        BilanParSpecialiteLettreLycee other = (BilanParSpecialiteLettreLycee) object;
    ...
    @Override
    public int compareTo(BilanParSpecialiteLettreLycee b) {
